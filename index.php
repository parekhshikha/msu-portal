...
<html lang="en">
    <head>
        ...
        <title>Student MSU Portal</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">Student MSU Portal</a>
        ...
        <header class="py-7 bg-image-full" style="background-image: url('images/intro.jpg')">
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Student MSU Portal <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
